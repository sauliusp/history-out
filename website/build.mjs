...
export async function build() {
  ...
  for (const page of pages) {
    ...
    const note = !released && !['/welcome/','/changelog/'].includes(page.route) ? '<div class="release-note">More control over your exports. A fresh look for HistoryOut. <a href="/changelog/">See what’s changing →</a><span>Store update pending.</span></div>' : '';
