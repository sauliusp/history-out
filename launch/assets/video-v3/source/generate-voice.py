...
for line in lines:
 ...
 results=list(model.generate(text=line['text'],ref_audio=str(reference),ref_text=ref_text,lang_code='English',temperature=0.6,top_p=0.9,max_tokens=1600,verbose=False))
